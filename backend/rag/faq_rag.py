...
class FAQSystem:
    ...
    def _create_system_prompt(self) -> str:
        ...
        return """You are a helpful medical clinic assistant for Sunrise Health Clinic. 
...
- Location: 45 Greenview Road , Lakeside Colony , Pune 411045
...
- Email: info@sunriseclinic.com"""
    ...
    def answer_question(self, question: str, include_sources: bool = False) -> FAQResponse:
        ...
        if not context:
            return FAQResponse(
                answer="I don't have specific information about that in my knowledge base. Please call us at +91-368-839-3829 or email info@sunriseclinic.com for assistance.",
                sources=[],
                confidence=0.3,
...
Please provide a helpful, accurate answer based on the context above."""
        ...
        try:
            ...
            return FAQResponse(
                answer="I apologize, but I'm having trouble accessing information right now. Please call us at +91-368-839-3829 for assistance.",
                sources=[],
                confidence=0.1,
                retrieved_chunks=[] if include_sources else None
            )
    ...
    def handle_multi_turn_question(
        ...
        if not context:
            return FAQResponse(
                answer="I don't have specific information about that. Please call +91-368-839-3829 for assistance.",
                sources=[],
                confidence=0.3,
                retrieved_chunks=[]
            )
        ...
        try:
            ...
            print(f"Error generating answer: {e}")
            return FAQResponse(
                answer="I'm having trouble right now. Please call +91-368-839-3829.",
                sources=[],
                confidence=0.1,
                retrieved_chunks=[]
            )
